package com.example.myapplication.ui.btech;
...
public class BtechFragment extends Fragment {
    ...
    Unbinder unbinder;
    private BtechViewModel btechViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btechViewModel =
                new ViewModelProvider(this).get(BtechViewModel.class);
    ...
    void check() {
        if (Objects.requireNonNull(edt_year.getText()).toString().length() < 1)
            ...
            switch (linkOperation) {
                ...
                case "201011":
                    driveLink = "https://mystuff.bublup.com/mybublup/#/mystuff/001-f-74633878-2b52-4c50-8f40-9e39335a67bb/mixed";
                    break;
                case "201012":
                    driveLink = "https://mystuff.bublup.com/mybublup/#/mystuff/001-f-1ec4fd18-307e-4a04-b618-0ce2b89e306b/mixed";
                    break;

                case "201013":
                    driveLink = "https://mystuff.bublup.com/mybublup/#/mystuff/001-f-f75eccd8-4ed8-4b40-866a-bb95b67bc732/mixed";
                    break;

                case "201111":
                    driveLink = "https://mystuff.bublup.com/mybublup/#/mystuff/001-f-4cb41c19-3af4-4070-afcc-03d6201baea4/mixed";
                    break;

                case "201112":
                    driveLink = "https://mystuff.bublup.com/mybublup/#/mystuff/001-f-c2fce0ae-a7a1-4a82-95af-9ccf65cf3927/mixed";
                    break;

                case "201113":
                    driveLink = "https://mystuff.bublup.com/mybublup/#/mystuff/001-f-05514f98-3d75-4882-8cf6-5152b448a56c/mixed";
                    break;
